...
using PracticaMachineLearning_NETML.Model;

namespace PracticaMachineLearning_NETML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"pathFile";
        private static string MODEL_FILEPATH = @"modelFilePath";
